...
class DiscordClient
{
	...
	private static var _defaultID:String = "1142972887653949470";
	...
	public static function changePresence(details:String, state:Null<String>, ?smallImageKey : String, ?hasStartTimestamp : Bool, ?endTimestamp: Float)
	{
		...
		_options.largeImageText = "Engine Version: " + states.MainMenuState.netherEngineVersion;
